              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i>Layouts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="theme/fixed_sidebar">Fixed Sidebar</a></li>
                      <li><a href="theme/fixed_footer">Fixed Footer</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="theme/e_commerce">E-commerce</a></li>
                      <li><a href="theme/projects">Projects</a></li>
                      <li><a href="theme/project_detail">Project Detail</a></li>
                      <li><a href="theme/contacts">Contacts</a></li>
                      <li><a href="theme/profile">Profile</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="theme/page_403">403 Error</a></li>
                      <li><a href="theme/page_404">404 Error</a></li>
                      <li><a href="theme/page_500">500 Error</a></li>
                      <li><a href="theme/plain_page">Plain Page</a></li>
                      <li><a href="theme/login">Login Page</a></li>
                      <li><a href="theme/pricing_tables">Pricing Tables</a></li>
                    </ul>
                  </li>
